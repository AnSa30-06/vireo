...
export const MANUAL = [
    ...
    blocks: [
      {
        steps: [
          ...
          ["Load the demo company", "A made-up company with realistic problems planted in it. None of your data is used. Do this first even if you have your own data — it takes one click and shows you what the product does before you spend time on file formats."],
    ...
    blocks: [
      {
        table: {
          ...
          rows: [
            ...
            ["Ask", "Type a question about your customers in your own words. It answers from a fixed list of questions it can do exactly, and refuses anything outside it."],
            ["Knowledge graph", "Your business drawn as the things in it and the links between them. Use it for questions about relationships rather than about one account."],
            ["Segments", "Groups of customers you define once by rules, and then reuse everywhere."],
            ["Dashboards", "Charts you build from your own metrics and keep."],
            ["Stories", "A written summary of a period, assembled from what actually happened."],
            ["Embed", "A read-only widget you can put in another page, scoped to exactly what you allow."],
            ["How to use this", "This manual."],
            ["Why this exists", "What the product is for, why the numbers are computed instead of generated, and what it will not do. The place to start if somebody else is looking over your shoulder."],
            ["Data", "Load the demo company, import your own folder, and see what was skipped and why."],
  ...
  },
  {
    ...
    blurb: "For questions about how things relate, rather than about one account.",
    blocks: [
      { p: "Most screens here answer questions about a customer. The knowledge graph answers questions about the links between them." },
      { p: "It is built from the same spreadsheets you already imported. Every customer, contact, ticket, invoice, event, signal and past decision becomes a point, and every real relationship between them becomes a line. Nothing new is stored, and nothing is guessed. It is worked out fresh from your tables each time, so it cannot disagree with them." },
      {
        callout: "Four questions you cannot ask a spreadsheet",
        kind: "fact",
        items: [
          "Which other customers share this one's owner, plan, segment or main contact, and carry the same problem right now.",
          "Everything that happened to one customer, in order, across all of your files at once.",
          "How two customers are connected, and through what.",
          "Which customers moved at the same time, and what they have in common that the rest of your customers do not.",
        ],
      },
      { p: "That last one is the useful one. If nine accounts all dropped this month and seven of them belong to the same owner, that is one problem, not nine. The screen shows you the share among the accounts that moved next to the share across your whole customer base, so you can see whether the thing they share is actually unusual." },
      { p: "The picture draws a readable part of the graph, not all of it. It always tells you how many points are not shown. Select any point to see its own links, its neighbours and its full history." },
    ],
  },
  {
    id: "data",
